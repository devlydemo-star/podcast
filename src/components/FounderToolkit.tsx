      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {activeTab === "overview" && (
          <div className="space-y-12 animate-in fade-in duration-300">
            ...
            {/* Featured PDF Booklet Spotlight Card */}
            <div className="group rounded-3xl p-6 sm:p-8 bg-white border border-slate-200 hover:border-teal-500/40 max-w-4xl mx-auto shadow-md relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 transition-all duration-300">
              <div className="flex items-center gap-5 relative z-10">
                {/* Visual 3D PDF Icon */}
                <div className="w-16 h-20 rounded-2xl bg-teal-50 border border-teal-200 flex-shrink-0 flex flex-col items-center justify-center text-teal-700 shadow-sm">
                  <FileText className="w-7 h-7 text-teal-600 mb-1" />
                  <span className="text-[9px] font-mono font-black tracking-widest text-teal-800">15 PGS</span>
                </div>

                <div>
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-teal-50 border border-teal-200 text-teal-700 text-[10px] font-bold uppercase tracking-wider">
                  ...
                  <h4 className="text-lg sm:text-xl font-black text-slate-900 group-hover:text-teal-600 transition-colors">
              ...
              <div className="flex items-center gap-3 w-full md:w-auto justify-end relative z-10">
                <button
                  onClick={() => setIsPdfModalOpen(true)}
                  className="flex-1 md:flex-initial inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-xs bg-slate-900 hover:bg-slate-800 text-white shadow-sm transition-all cursor-pointer transform hover:scale-[1.02]"
                >
                  <Eye className="w-4 h-4 text-teal-400" />
                ...
                <a
                  href={PDF_URL}
                  download={PDF_FILENAME}
                  className="flex-1 md:flex-initial inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-bold text-xs bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 hover:border-slate-300 transition-all cursor-pointer shadow-sm"
                >
                  <Download className="w-4 h-4 text-teal-600" />
                  <span>Download</span>
                </a>
