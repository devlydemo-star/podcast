  ...
  const takeaways: TakeawayItem[] = [
    {
      ...
      icon: <Lightbulb className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Strategy",
    },
    {
      id: "learning-systems",
      ...
      icon: <Cpu className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Engineering",
    },
    {
      id: "building-habits",
      ...
      icon: <Clock className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Discipline",
    },
    {
      id: "ai-insights",
      ...
      icon: <Bot className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Future Tech",
    },
    {
      id: "product-dev",
      ...
      icon: <Layers className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Execution",
    },
    {
      ...
      icon: <Brain className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Mindset",
    },
    {
      id: "productivity",
      ...
      icon: <Target className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Systems",
    },
    {
      id: "career-growth",
      ...
      icon: <TrendingUp className="w-5 h-5 text-[#2BF4C3]" />,
      tag: "Trajectory",
    },
  ];

  return (
    <section id="takeaways" className="py-24 relative bg-[#020B09] border-t border-white/5">
      {/* Background ambient lighting */}
      <div className="absolute top-1/2 right-1/3 w-[500px] h-[500px] bg-[#2BF4C3]/5 rounded-full blur-[170px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#081717] border border-[#2BF4C3]/30 mb-3.5 shadow-sm">
            <GraduationCap className="w-3.5 h-3.5 text-[#2BF4C3]" />
            <span className="text-xs font-bold uppercase tracking-wider text-[#2BF4C3]">
              Tangible Skills
            </span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight">
            What You&apos;ll <span className="text-gradient-teal">Take Away</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {takeaways.map((item) => (
            <div
              key={item.id}
              className="glass-panel-hover rounded-3xl p-6 flex flex-col justify-between group relative overflow-hidden transition-all duration-300 border border-white/5 hover:border-[#2BF4C3]/35"
            >
              {/* Subtle hover wash */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#2BF4C3]/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />

              <div>
                {/* Header row with icon & tag */}
                <div className="flex items-center justify-between mb-4">
                  <div className="w-11 h-11 rounded-xl bg-[#081717] border border-white/10 flex items-center justify-center shadow-inner group-hover:scale-105 group-hover:border-[#2BF4C3]/40 transition-all">
                    {item.icon}
                  </div>
                  <span className="text-[10px] font-mono uppercase font-bold text-[#94A3B8] bg-white/5 px-2.5 py-0.5 rounded-full border border-white/10 group-hover:text-[#2BF4C3] group-hover:border-[#2BF4C3]/30 transition-colors">
                    {item.tag}
                  </span>
                </div>

                {/* Title & Subtitle */}
                <h3 className="text-lg font-bold text-white group-hover:text-[#2BF4C3] transition-colors leading-tight">
                  {item.title}
                </h3>
                <p className="text-xs font-semibold text-[#2BF4C3]/90 mt-1 mb-2.5">
                  {item.subtitle}
                </p>
              ...
              {/* Bottom indicator */}
              <div className="mt-5 pt-3 border-t border-white/5 flex items-center gap-1.5 text-[11px] text-white/70">
                <CheckCircle className="w-3.5 h-3.5 text-[#2BF4C3]" />
