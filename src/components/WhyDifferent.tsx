...
export default function WhyDifferent() {
  ...
  return (
    <section id="why-different" className="py-24 relative bg-white border-t border-slate-200/80">
      ...
      <div className="absolute top-1/2 right-1/4 w-[500px] h-[500px] bg-teal-500/5 rounded-full blur-[170px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight">
            Why This Show <span className="text-teal-600">Is Different</span>
          </h2>
